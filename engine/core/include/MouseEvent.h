...
namespace lk {
    ...
    class LANIAKEA_API MouseMovedEvent : public Event
    {
    public:
    ...
    class LANIAKEA_API MouseScrolledEvent : public Event
    {
    public:
    ...
    class LANIAKEA_API MouseButtonEvent : public Event
    {
    public:
    ...
    class LANIAKEA_API MouseButtonPressedEvent : public MouseButtonEvent
    {
    public:
    ...
    class LANIAKEA_API MouseButtonReleasedEvent : public MouseButtonEvent
    {
    public:
